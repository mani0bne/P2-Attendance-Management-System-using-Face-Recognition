...
```bash
git clone https://github.com/mani0bne/P2-Attendance-Management-System-using-Face-Recognition.git
```
...
For any questions or issues, feel free to contact **manihasnetha@gmail.com**.
